...
pub const ENABLE_RAM_BANK_START: u16 = 0x0000;
pub const ENABLE_RAM_BANK_END: u16 = 0x2000;

pub const CHOOSE_ROM_BANK_START: u16 = 0x2000;
pub const CHOOSE_ROM_BANK_END: u16 = 0x4000;
...
pub const CHOOSE_RAM_BANK_START: u16 = 0x4000;
pub const CHOOSE_RAM_BANK_END: u16 = 0x6000;

pub const CHOOSE_MEMORY_MODE_START: u16 = 0x6000;
pub const CHOOSE_MEMORY_MODE_END: u16 = 0x8000;
